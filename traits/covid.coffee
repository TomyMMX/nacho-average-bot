detect = (robot, res) ->
    if res.message.rawMessage.text?.match(/covid|c19|covid-19|coronavirus|'corona virus'|koronavirus|korona|rona|corona|pandemic|epidemic|'social distance'|mask|PPI|/i)
        ...
        robot.http("https://api.covid19api.com/summary")
            .get() (err, response, body) ->
                if (err)
                    ...
                    res.send "Only today " + data.Globl.NewDeaths + " people died"
